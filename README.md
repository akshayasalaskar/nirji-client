This application is built using Next.js for the frontend and Node.js for the backend, providing a seamless experience for user authentication and image management.
